...
foreach( $xlsx->rows() as $r ) 
{
	...
	$days = getWeekDays($pickup_date,$drop_date);
	...
	if(mysqli_num_rows($sql) > 0)
	{
		...
		$driver = $rlt['night_rate'] * $days;
		
		echo "$booking_id - $driver<br>"; continue;
	...
	{
		echo $booking_id." - "."Booking/Rate does not exist<br>";
		$k++;
		continue;
	}
