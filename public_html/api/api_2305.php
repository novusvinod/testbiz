			...
			try
			{
				...
				switch($type)
				{
					...
					case '3':  //Archived Assigned
					{
						...
						from bookings `b`
						left join groups `g` on b.group_id = g.id 
						left join admins `a` on g.admin_id = a.id where b.status_user = 1 and (b.status_auth1 = 1 OR b.status_auth2 = 1) and b.status_auth_taxivaxi = 3 and b.is_invoice = 0  order by pickup_datetime desc";
						break;
					}
